...
namespace ContactService.UnitTests.Application
{
  public class ContactsControllerTest
  {
    ...
    public async Task Get_all_contact_infos_OK()
    {
      ...
      Assert.IsType<CustomResponse<IList<ContactInfoVo>>>(objectResult.Value);
    }
    ...
    public async Task Get_all_contacts_OK()
    {
      ...
      Assert.Equal(objectResult.StatusCode, (int)System.Net.HttpStatusCode.OK);
      Assert.IsType<CustomResponse<IList<ContactIndexVo>>>(objectResult.Value);
    }
    ...
    public async Task Get_contact_by_id_OK()
    {
      ...
      //Assert
      var objectResult = (ObjectResult)actionResult;
      var response = (CustomResponse<ContactVo>)objectResult.Value;
    ...
    public async Task Create_contact_created()
    {
      ...
      var model = _mapper.Map<ContactEditVo>(fakeContact);
    ...
    public async Task Create_contact_model_valid()
    {
      ...
      //Assert
      Assert.True(results.Any(x => x.MemberNames.Contains(nameof(ContactEditVo.Name))));
    }
    ...
    public async Task Create_contact_info_created()
    {
      ...
      var model = _mapper.Map<ContactInfoVo>(fakeContactInfo);
    ...
    public async Task Create_contact_info_model_valid()
    {
      ...
      Assert.True(results.Any(x => x.MemberNames.Contains(nameof(ContactInfoVo.Value))));
      Assert.True(results.Any(x => x.MemberNames.Contains(nameof(ContactInfoVo.ContactId))));
    }
