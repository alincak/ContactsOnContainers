...
namespace ReportService.UnitTests.Application
{
  public class ReportsControllerTest
  {
    ...
    public async Task Get_all_reports_OK()
    {
      ...
      Assert.IsType<CustomResponse<IList<ReportIndexVo>>>(objectResult.Value);
    }
    ...
    public async Task Get_report_by_id_OK()
    {
      ...
      //Assert
      var objectResult = (ObjectResult)actionResult;
      var response = (CustomResponse<ReportVo>)objectResult.Value;
